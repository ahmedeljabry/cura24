...
//        make a function to call all static option by home page
    ...
    public function showAdminForgetPasswordForm()
    {
        ...
        // Check if the user is authenticated under the 'web' guard
    ...
    public function lang_change(Request $request, $lang = null)
    {
        $selected_lang = $lang ?? $request->lang;

        if (!empty($selected_lang) && Language::where(['slug' => $selected_lang, 'status' => 'publish'])->exists()) {
