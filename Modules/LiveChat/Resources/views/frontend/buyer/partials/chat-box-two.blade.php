              ...
              <div class="hat-wrapper-details-footer-btn btn_flex justify-content-end mt-2">
                  <form method="post" enctype="multipart/form-data" class="upload-frm" data-to-user-prefix="buyer" id="dashbaord_chat_form">
                      <div class="file-upload-wrapper" style="display: flex; align-items: center; gap: 10px;">
                          <span id="removeAttachedFile"
                                style="display: none; cursor: pointer; color: red;"
                                title="{{ __('Remove attached file') }}">
                                <i class="fas fa-times"></i>
                            </span>
                          <label class="dropMedia dashboard_table__title__btn btn-outline-border radius-5"
                                 for="inputTag" style="margin: 0;">
                              <input type="file" name="image" class="new_image_add dropMedia__uploader image"
                                     accept="image/png, image/gif, image/jpeg" id="inputTag"/>
