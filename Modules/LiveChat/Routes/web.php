...
use Modules\LiveChat\Http\Controllers\Frontend\SellerChatController;
...
Route::group(['prefix'=>'seller','middleware'=> ['auth','inactiveuser','BuyerCheck','userEmailVerify','setlang','globalVariable']],function() {
    ...
    Route::get('/chat/unread-count', [SellerChatController::class, 'getUnreadCount'])->name('seller.chat.unread.count');
...
Route::group(['prefix'=>'buyer','middleware'=>['auth','inactiveuser','UserRoleCheck','userEmailVerify','setlang','globalVariable']],function() {
    ...
    Route::get('/chat/unread-count', [BuyerChatController::class, 'getUnreadCount'])->name('buyer.chat.unread.count');
