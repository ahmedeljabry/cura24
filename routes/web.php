...
//    Route::match(['get', 'post'], '/email-verify', 'Auth\RegisterController@emailVerify')->name('email.verify')->middleware('auth:web');
    ...
    Route::get('/lang/change/{lang?}', 'FrontendController@lang_change')->name('frontend.lang.change');
    ...
    Route::group(['prefix' => 'service-list'], function () {
        ...
        Route::post('buyer/add-favourite/{service_id}', 'FavouriteServiceController@create')->name('service.list.buyer.add-favourite.service');
        Route::post('buyer/remove-favourite', 'FavouriteServiceController@destroy')->name('service.list.buyer.remove-favourite.service');
