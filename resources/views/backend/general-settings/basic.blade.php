                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.basic.settings')}}" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group" id="captcha_version_wrapper" style="{{ get_static_option('site_google_captcha_enable') ? '' : 'display:none;' }}">
                                <label for="site_google_captcha_version"><strong>{{__('Google Captcha Version')}}</strong></label>
                                <select name="site_google_captcha_version" class="form-control">
                                    <option value="v2" @if(get_static_option('site_google_captcha_version') === 'v2') selected @endif>{{__('reCAPTCHA v2')}}</option>
                                    <option value="v3" @if(get_static_option('site_google_captcha_version') === 'v3') selected @endif>{{__('reCAPTCHA v3')}}</option>
                                </select>
                            </div>
                            <div class="form-group">
