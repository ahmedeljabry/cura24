                    ...
                    <div class="card-body">
                        ...
                        <div class="table-wrap table-responsive">
                            ...
                            <div class="mb-2" style="display: flex; justify-content: flex-end;">
                                <form action="{{ route('admin.area.search') }}" method="get" class="form-inline">
                                    <div class="form-group">
                                        <label for="area_search" class="sr-only">{{__('Search Area')}}</label>
                                        <input type="text" class="form-control" name="area_search" id="area_search" value="{{ old('area_search') }}" placeholder="{{__('Search Area')}}">
                                    </div>
