                        ...
                        <form action="{{route('admin.brand.edit',$brand->id )}}" method="post">
                            ...
                            <div class="tab-content margin-top-40">
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#brand-edit-it" role="tab" style="color:blue">{{__('Italian (Default)')}}</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#brand-edit-en" role="tab" style="color:blue">{{__('English')}}</a></li>
                                </ul>
                                <div class="tab-content mb-3">
                                    <div class="tab-pane fade show active" id="brand-edit-it" role="tabpanel">
                                    ...
                                    <div class="tab-pane fade" id="brand-edit-en" role="tabpanel">
                                        <div class="form-group">
                                            <label for="title_en">{{__('Brand Title (English)')}}</label>
                                            <input type="text" class="form-control" name="title_en" value="{{ $brand->title_en }}" placeholder="{{__('Title')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
