                                    ...
                                    <div class="card-body">
                                        <div class="tab-content" id="subcategoryLangTabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="subcategory-it" role="tabpanel" aria-labelledby="subcategory-it-tab">
                                                <div class="form-group">
                                                    <label for="name">{{__('Sub Category Name (Italian)')}}</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" id="description" class="d-none">{{ $subcategory->description}}</textarea>
                                                </div>
                                            </div>
                                            <!-- English Tab -->
                                            <div class="tab-pane fade" id="subcategory-en" role="tabpanel" aria-labelledby="subcategory-en-tab">
                                                <div class="form-group">
                                                    <label for="name_en">{{__('Sub Category Name (English)')}}</label>
                                                    <input type="text" class="form-control" name="name_en" id="name_en" value="{{$subcategory->name_en}}" placeholder="{{__('Sub Category Name (English)')}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>{{__('Description (English)')}}</label>
                                                    <textarea id="jodit-editor-en" style="height: 400px;"></textarea>
                                                    <textarea name="description_en" id="description_en" class="d-none">{{ $subcategory->description_en}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-xl-8 col-lg-9">
                                                        <div class="tab-content meta-content" id="v-pills-tabContent">
                                                            ...
                                                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                                <ul class="nav nav-tabs mb-3" id="subCatMetaLangTab" role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" id="subcat-meta-it-tab" data-toggle="tab" href="#subcat-meta-it" role="tab" style="color: blue">{{__('Italian (Default)')}}</a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" id="subcat-meta-en-tab" data-toggle="tab" href="#subcat-meta-en" role="tab" style="color: blue">{{__('English')}}</a>
                                                                    </li>
                                                                </ul>
                                                                <div class="tab-content">
                                                                    <div class="tab-pane fade show active" id="subcat-meta-it" role="tabpanel">
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="meta_tags" value="{{$subcategory->metaData->meta_tags ?? ''}}" placeholder="{{ __('Slug') }}" data-role="tagsinput">
                                                                        </div>
                                                                        <div class="row">
                                                                    ...
                                                                    <div class="tab-pane fade" id="subcat-meta-en" role="tabpanel">
                                                                        <div class="form-group">
                                                                            <label for="meta_title_en">{{__('Meta Title (English)')}}</label>
                                                                            <input type="text" class="form-control" name="meta_title_en" value="{{$subcategory->metaData->meta_title_en ?? ''}}" placeholder="{{__('Title')}}">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="meta_tags_en">{{__('Meta Tags (English)')}}</label>
                                                                            <input type="text" class="form-control" name="meta_tags_en" value="{{$subcategory->metaData->meta_tags_en ?? ''}}" placeholder="{{ __('Slug') }}" data-role="tagsinput">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="meta_description_en">{{__('Meta Description (English)')}}</label>
                                                                                <textarea name="meta_description_en" class="form-control max-height-140 meta-desc" cols="20" rows="4"> {!! $subcategory->metaData->meta_description_en ?? '' !!} </textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                                                <ul class="nav nav-tabs mb-3" id="subCatFbMetaLangTab" role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" id="subcat-fb-meta-it-tab" data-toggle="tab" href="#subcat-fb-meta-it" role="tab" style="color: blue">{{__('Italian (Default)')}}</a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" id="subcat-fb-meta-en-tab" data-toggle="tab" href="#subcat-fb-meta-en" role="tab" style="color: blue">{{__('English')}}</a>
                                                                    </li>
                                                                </ul>

                                                                <div class="tab-content">
                                                                    <div class="tab-pane fade show active" id="subcat-fb-meta-it" role="tabpanel">
                                                                        <div class="form-group">
                                                                            <label for="title">{{__('Facebook Meta Title (Italian)')}}</label>
                                                                            <input type="text" class="form-control" data-role="tagsinput" name="facebook_meta_tags" value="{{$subcategory->metaData->facebook_meta_tags ?? ''}}">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="tab-pane fade" id="subcat-fb-meta-en" role="tabpanel">
                                                                        <div class="form-group">
                                                                            <label for="facebook_meta_tags_en">{{__('Facebook Meta Title (English)')}}</label>
                                                                            <input type="text" class="form-control" data-role="tagsinput" name="facebook_meta_tags_en" value="{{$subcategory->metaData->facebook_meta_tags_en ?? ''}}">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="facebook_meta_description_en">{{__('Facebook Meta Description (English)')}}</label>
                                                                                <textarea name="facebook_meta_description_en" class="form-control max-height-140 meta-desc" cols="20" rows="4">{!! $subcategory->metaData->facebook_meta_description_en ?? '' !!}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="media-upload-btn-wrapper">
                                                                        ...
                                                                        <input type="hidden" id="facebook_meta_image" name="facebook_meta_image" value="{{$subcategory->metaData->facebook_meta_image ?? ''}}">
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                                                <ul class="nav nav-tabs mb-3" id="subCatTwMetaLangTab" role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" id="subcat-tw-meta-it-tab" data-toggle="tab" href="#subcat-tw-meta-it" role="tab" style="color: blue">{{__('Italian (Default)')}}</a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" id="subcat-tw-meta-en-tab" data-toggle="tab" href="#subcat-tw-meta-en" role="tab" style="color: blue">{{__('English')}}</a>
                                                                    </li>
                                                                </ul>

                                                                <div class="tab-content">
                                                                    <div class="tab-pane fade show active" id="subcat-tw-meta-it" role="tabpanel">
                                                                        <div class="form-group">
                                                                            <label for="title">{{__('Twitter Meta Tag (Italian)')}}</label>
                                                                            <input type="text" class="form-control" data-role="tagsinput" name="twitter_meta_tags" value=" {{$subcategory->metaData->twitter_meta_tags ?? ''}}">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="tab-pane fade" id="subcat-tw-meta-en" role="tabpanel">
                                                                        <div class="form-group">
                                                                            <label for="twitter_meta_tags_en">{{__('Twitter Meta Tag (English)')}}</label>
                                                                            <input type="text" class="form-control" data-role="tagsinput" name="twitter_meta_tags_en" value=" {{$subcategory->metaData->twitter_meta_tags_en ?? ''}}">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="twitter_meta_description_en">{{__('Twitter Meta Description (English)')}}</label>
                                                                                <textarea name="twitter_meta_description_en" class="form-control max-height-140 meta-desc" cols="20" rows="4">{!! $subcategory->metaData->twitter_meta_description_en ?? '' !!}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="media-upload-btn-wrapper">
                                                                        ...
                                                                        <input type="hidden" id="twitter_meta_image" name="twitter_meta_image" value="{{$subcategory->metaData->twitter_meta_image ?? ''}}">
                                                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Image')}}" data-modaltitle="{{__('Upload Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                                            {{__('Change Image')}}
                                                                        </button>
                                                                    </div>
