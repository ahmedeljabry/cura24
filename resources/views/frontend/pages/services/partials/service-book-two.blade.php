                                                            ...
                                                            <div class="new_packageBook__addFeature__flex">
                                                                ...
                                                                <div class="btn-wrapper">
                                                                    <div class="package_quantity">
                                                                        <span class="substract package_quantity__icon include_service_qty_decrement" style="opacity:0.35; pointer-events:none; cursor:not-allowed;">
                                                                        ...
                                                                        <span class="plus package_quantity__icon inc_dec_include_service {{ $include->include_service_quantity <= 1 ? 'disabled' : '' }}" style="{{ $include->include_service_quantity <= 1 ? 'opacity:0.35; pointer-events:none; cursor:not-allowed;' : '' }}"><i class="fa-solid fa-plus"></i></span>
                                                                        =======
                                                                        value="1" {{ $include->include_service_quantity <= 1 ? 'readonly' : '' }} oninput="validateNumberInput(this)">
                                                                        <span class="plus package_quantity__icon include_service_qty_increment {{ $include->include_service_quantity <= 1 ? 'disabled' : '' }}" style="{{ $include->include_service_quantity <= 1 ? 'opacity:0.35; pointer-events:none; cursor:not-allowed;' : '' }}"><i class="fa-solid fa-plus"></i></span>
                                                                        >>>>>>> ab4c5a4 (refactor: update increment/decrement functionality for service quantities in service booking pages)
                                                                    </div>
                                                                </div>
                                                                <div class="btn-wrapper">
                                                                ...
                                                                <div class="new_packageBook__addFeature__flex">
                                                                    ...
                                                                    <div class="btn-wrapper">
                                                                        <div class="package_quantity">
                                                                            ...
                                                                            <span class="substract package_quantity__icon additional_service_qty_decrement disabled" style="opacity:0.35; pointer-events:none; cursor:not-allowed;"><i class="fa-solid fa-minus"></i></span>
                                                                            <input type="number" min="1" max="{{ $additional->additional_service_quantity }}" class="quantity-input package_quantity__input inc_dec_additional_service"
                                                                            ...
                                                                            <span class="plus package_quantity__icon additional_service_qty_increment {{ $additional->additional_service_quantity <= 1 ? 'disabled' : '' }}" style="{{ $additional->additional_service_quantity <= 1 ? 'opacity:0.35; pointer-events:none; cursor:not-allowed;' : '' }}"><i class="fa-solid fa-plus"></i></span>
                                                                        </div>
                                                                    </div>
