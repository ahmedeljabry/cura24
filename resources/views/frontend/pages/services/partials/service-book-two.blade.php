                                                                    ...
                                                                    <div class="new_packageBook__addFeature__flex">
                                                                        ...
                                                                        <div class="btn-wrapper">
                                                                            <div class="package_quantity">
                                                                                ...
                                                                                <span class="plus package_quantity__icon additional_service_qty_decrement {{ $additional->additional_service_quantity <= 1 ? 'disabled' : '' }}" style="{{ $additional->additional_service_quantity <= 1 ? 'opacity:0.35; pointer-events:none; cursor:not-allowed;' : '' }}"><i class="fa-solid fa-plus"></i></span>
                                                                            </div>
                                                                        </div>
