                                                                            ...
                                                                            @if($service_details_for_book->is_service_online !=1)
                                                                                <div class="btn-wrapper">
                                                                                    <div class="package_quantity">
                                                                                        <span class="substract package_quantity__icon include_service_qty_decrement {{ $include->include_service_quantity <= 1 ? 'disabled' : '' }}"
                                                                                        ...
                                                                                        <input type="number" min="1"
                                                                                               ...
                                                                                               {{ $include->include_service_quantity <= 1 ? 'readonly' : '' }}
                                                                        ...
                                                                        <div class="new_packageBook__addFeature__flex">
                                                                            ...
                                                                            <div class="btn-wrapper">
                                                                                <div class="package_quantity">
                                                                                    ...
                                                                                    <span class="substract package_quantity__icon additional_service_qty_decrement {{ $additional->additional_service_quantity <= 1 ? 'disabled' : '' }}"
                                                                                    ...
                                                                                    <input type="number"
                                                                                           ...
                                                                                           {{ $additional->additional_service_quantity <= 1 ? 'readonly' : '' }}
                                                                                           oninput="validateNumberInput(this)">
                                                                                    <span class="plus package_quantity__icon inc_dec_additional_service {{ $additional->additional_service_quantity <= 1 ? 'disabled' : '' }}"
                                                                                          style="{{ $additional->additional_service_quantity <= 1 ? 'opacity:0.35; pointer-events:none; cursor:not-allowed;' : '' }}">
                                                                                        <i class="fa-solid fa-plus"></i></span>
                                                                                </div>
                                                                            </div>
