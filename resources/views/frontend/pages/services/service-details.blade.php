...
@section('style')
    ...
    <style>
        /* Force table borders inside service description */
        .details-content-tab table {
            width: 100%;
            border-collapse: collapse;
        }

        .details-content-tab th,
        .details-content-tab td {
        ...
        .details-content-tab ul {
            list-style: disc !important;
            padding-left: 1.5rem !important; /* restore indent */
            margin-bottom: 1rem !important;
        }

        .details-content-tab ul li {
            list-style: disc !important; /* restore bullets */
            display: list-item !important;
            margin-bottom: 0.5rem;
        }

        .details-content-tab ol {
            list-style: decimal !important;
            padding-left: 1.5rem !important; /* restore indent */
            margin-bottom: 1rem !important;
            counter-reset: none !important; /* disable custom counter */
        }

        .details-content-tab ol li {
            list-style: decimal !important;
            display: list-item !important;
            margin-bottom: 0.5rem;
            counter-increment: none !important; /* disable custom counter */
        }

        /* Remove the ::before content that adds custom numbers */
        .details-content-tab ol li:before {
