        ...
        $(document).ready(function() {
            // add what new inclue
             $(".add-what-includes").on('click',function(){
                ...
                let service_title = "{{__('Service title')}}";
                let add_price = "{{__('Add Price')}}";
                let add_quantity = "{{__('Add Quantity')}}";
                let faq_title = "{{__('Faq Title')}}";
                let faq_description = "{{__('Faq Description')}}";
                let select_image = "{{__('Select Image')}}";
                let upload_image = "{{__('Upload Image')}}";
                let remove = "{{__('Remove')}}";
                let type_here = "{{__('Type Here')}}";
                ...
                if(total_element < max ){
                  $(".append-additional-includes").append(
                        '<div class="single-dashboard-input what-include-element">\
                            ...
                            <div class="single-info-input margin-top-20 @if($get_service->is_service_online == 1) is_service_online_hide @endif">\
                                <label>'+price+'</label>\
                                <input class="form--control include-price" type="number" step="0.01" name="include_service_price[]" placeholder="'+add_price+'">\
                            </div>\
                            <div class="single-info-input margin-top-20 @if($get_service->is_service_online == 1) is_service_online_hide @endif">\
                 ...
                 if(total_element < max ){
                  $(".append-additional-services").append(
                      '<div class="single-dashboard-input additional-services">\
                            ...
                            <div class="single-info-input margin-top-20">\
                                <label>'+price+'</label>\
                                <input class="form--control numeric-value" type="text" name="additional_service_price[]" placeholder="'+add_price+'">\
                            </div>\
                            <div class="single-info-input margin-top-20">\
                                <label>'+quantity+'</label>\
                            ...
                            <div class="single-info-input margin-top-30">\
                                <div class="form-group ">\
                                    <div class="media-upload-btn-wrapper">\
                                        ...
                                        <input type="hidden" name="image[]">\
                                        <button type="button" class="btn btn-info media_upload_form_btn"\
                                                data-btntitle="'+select_image+'"\
                                                data-modaltitle="'+upload_image+'" data-toggle="modal"\
                                                data-target="#media_upload_modal">\
                                            '+upload_image+'\
                                        </button>\
                                    </div>\
                  ...
                  $(".append-benifits").append(
                      '<div class="single-dashboard-input benifits">\
                        <div class="single-info-input margin-top-20">\
                           ...
                           <input class="form--control" type="text" name="benifits[]" placeholder="'+type_here+'">\
                        </div>\
                        <div class="single-info-input margin-top-20">\
                           <label>Benefit (English)</label>\
                           <input class="form--control" type="text" name="benifits_en[]" placeholder="'+type_here+'">\
