@php
    if(moduleExists('LiveChat')){
        ...
        if (Auth::guard('web')->check()) {
            ...
            $totalUnreadMessages = Modules\LiveChat\Entities\LiveChatMessage::where(
            ...
            <div class="dashboard__header__right">
                <div class="dashboard__header__right__flex">
                    ...
                    <div class="dashboard__header__right__item">
                        @if(moduleExists("LiveChat"))
                            <div class="dashboard__header__chat">
                                <a href="{{ Auth::guard('web')->user()->user_type == 0 ? route('seller.live.chat') : route('buyer.live.chat') }}"
                                   class="dashboard__header__chat__icon" title="{{ __('View Chats') }}"
                                   style="position: relative; display: inline-block;">
                                    <i class="fa-solid fa-comment"></i>
                                    <span id="chat-unread-count" class="dashboard__header__notification__number"
                                          style="position: absolute; top: -8px; right: -8px; background: red; color: white; border-radius: 50%; padding: 3px 7px; font-size: 12px; line-height: 1; z-index: 10;">
