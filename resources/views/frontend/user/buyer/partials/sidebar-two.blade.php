    ...
    <div class="dashboard__left__main">
        ...
        <div class="dashboard__bottom mt-5">
            <ul class="dashboard__bottom__list dashboard-list">
                ...
                <li class="dashboard__bottom__list__item @if(request()->is('buyer/services*')) active @endif">
                    <a href="{{ route('buyer.services') }}"><i class="las la-list-alt"></i> {{ __('All Services') }}</a>
                </li>
