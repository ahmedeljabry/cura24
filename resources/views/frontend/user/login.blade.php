            ...
            <div class="signup-contents">
                ...
                <div class="social-login-wrapper">
                    ...
                    <div class="sin-in-with">
                        ...
                        <a href="{{ route('login.google.redirect', ['type' => null, 'origin' => 'login']) }}" class="sign-in-btn">
                            <img src="{{ asset('assets/frontend/img/static/google.png') }}" alt="icon">
                            {{ __('Sign in with Google') }}
                        </a>
                        @endif
                        @if(get_static_option('enable_facebook_login'))
                        <a href="{{ route('login.facebook.redirect', ['type' => null, 'origin' => 'login']) }}" class="sign-in-btn">
